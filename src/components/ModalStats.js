...
const ModalStats = ({
    ...
    return ( 
            <Grid container sx={{backgroundColor:'white',width:'80%', padding:'20px 0',  position: 'absolute',
            top: '50%',
            left: '50%',transform: 'translate(-50%, -50%)',}} justifyContent="center">
                <Grid item xs={10}><h3>{player.name}</h3>
                </Grid>
                <Grid item xs={10}>
                ...
                <Grid item container xs={10} justifyContent="center" rowSpacing={3}>
                    <Grid item container xs={8} justifyContent="center">
                        ...
                        <Grid item xs={2}>
                            <IconButton onClick={() => statUp(valueK, 'strikeout')}>
                            {player.strikeout}
                            </IconButton>
                        </Grid>
                    </Grid>
                    <Grid item container xs={8} justifyContent="center">
                        ...
                        <Grid xs={2}>
                            <IconButton onClick={() => statUp(valueO, 'out')}>{player.out}</IconButton>
                        </Grid>
                    </Grid>
                    <Grid item container xs={8} justifyContent="center">
                        <Grid item xs={10}>
                        ...
                        <Grid item xs={2}>
                            <IconButton onClick={() => onHandleDesignatedHitter(valueD)}>
                                <DoubleArrowIcon color='success' sx={{ fontSize: 40 }}/>
                            </IconButton>
                        </Grid>
                    </Grid>
                </Grid>
